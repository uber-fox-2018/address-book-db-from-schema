const ControllerKontak = require('./controller/controllerKontak')
const ControllerGrup = require('./controller/conrtollerGrup')
const ControllerKontakGrup = require('./controller/controllerKontakGrup')
...
switch (command) {
    ...
    case 'updateKontak':
                        ...
                        break;
    case 'deleteKontakById':
                        var id = argv[3]
                        ControllerKontak.deleteById(id)
                        break;
    ...
    //static
    case 'findKontakById':
                        var id = Number(argv[3])
                        ControllerKontak.findById(id)
                        break;
